            ...
            <div class="col-lg-12 col-ml-12">
                <div class="row">
                    ...
                    <div class="col-12 mt-3">
                        <div class="card">
                            <div class="card-body">
                                <form id="application-form" name="application-form" action="{{ route('admin-application-update', ['id'=> $application->id]) }}" enctype="multipart/form-data" method="POST">
                                    @csrf
                                    ...
                                    <div class="row form-group justify-content-between">
                                        <div>
                                            <h4 class="header-title application-add-title">Edit applications</h4>
                                        </div>
                                        <div>
                                    ...
                                    <div class="row form-group">
                                        <div class="col-md-8">
                                            ...
                                            <input type="text" class="form-control" name="name" placeholder="Name" required value="{{$application->name}}">
                                        </div>
                                        <div class="col-md-4">
                                    ...
                                    <div class="row form-group">
                                        <div class="col-md-12">
                                            ...
                                            <input type="text" class="form-control" name="title" placeholder="Title"  value="{{$application->title}}">
                                        </div>
                                    </div>
                                    <div class="row form-group">
                                        <div class="col-md-12">
                                            <label for="services" class="col-form-label">Keywords</label>
                                            <textarea rows="3" cols="200" type="text" class="form-control" name="keywords" placeholder="Keywords"  >{{$application->keywords}}</textarea>
                                        </div>
                                    </div>
                                    <div class="row form-group">
                                        <div class="col-md-12">
                                            <label for="services" class="col-form-label">Description</label>
                                            <textarea rows="3" cols="200" type="text" class="form-control" name="description" placeholder="Description"  >{{$application->description}}</textarea>
                                        </div>
                                    </div>
