                    ...
                    <div class="card-body">
                        <div class="row form-group justify-content-between">
                            <div >
                                ...
                                @endif
                                <h4 class="header-title">List of contact</h4>
                            </div>
                        </div>
                        <div class="row">
                                    ...
                                    @foreach($contacts as $contact)
                                        <tr>
                                            ...
                                            <td style="vertical-align: middle;">
                                                <a href="{{ route('admin-contact-view', ['id'=> $contact->id]) }}" title="Detail">
                                                    <i class="fa fa-eye"></i>
                                                </a>
                                                <a class="contact-remove" href="{{ route('admin-contact-delete', ['id'=> $contact->id]) }}"
